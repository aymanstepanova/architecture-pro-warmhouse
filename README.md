...
В системе выделены домены:
- Управление устройствами
- Телеметрия/Мониторинг состояния дома 
...
[Контекстная диаграмма](https://github.com/aymanstepanova/architecture-pro-warmhouse/blob/warmhouse/schemas/context_c4_as_is.puml)
